...
this.router.delete('/deleteuser/:id', this.deleteUser);
        //#@gepdelimeterone@#
        this.router.get('/facebooklogin/:id', this.apifacebooklogin);
...
public deleteUser(req: Request, res: Response) {
    ...
    public async apifacebooklogin(req: Request, res: Response) 
 {
  try
  {
      let user = await Promise.resolve(new ApiAdapter().get(`${Constants.loginUrl}/getuser/`+req.params.id));
      // @ts-ignore
