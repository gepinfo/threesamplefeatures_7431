...
export class LoginComponent implements OnInit 
{
    ...
    this.activatedRoute.queryParams.subscribe((params:any) => 
 {
    ...
    this.authfblogin(params['id'], params['signintype'])
 });
    ...
    this.activatedRoute.queryParams.subscribe((params:any) => 
 {
  ...
  public authfblogin(id:any, signinType:string)
 {
    if(signinType == 'facebook')
    {
      this.loginservice.authfacebooklogin(id).subscribe(async logindetails =>
      {
